...
public class APEdgeGrabTrigger : MonoBehaviour 
{
    ...
    void HandleEdgeGrab(Collider2D otherCollider)
    {
        ...
        APCharacterController.State[] allowedStates = { APCharacterController.State.Crouch, APCharacterController.State.Standard, APCharacterController.State.MeleeAttack, APCharacterController.State.RangedAttack, 
