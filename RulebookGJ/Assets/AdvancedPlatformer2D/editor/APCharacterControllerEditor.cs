...
public class APCharacterControllerEditor : Editor
{
	...
	public void OnSceneGUI () 
	{
		...
		if (oController.m_meleeAttacks != null && oController.m_meleeAttacks.m_enabled)
		{
		...
		if (oController.m_rangedAttacks != null && oController.m_rangedAttacks.m_enabled && m_bShow)
		{
