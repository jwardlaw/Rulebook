...
public class APSampleGUI : APCharacterEventListener 
{
	...
	public void Update()
	{
		if(m_fadeToBlack)
		{
			m_fadeAlpha = Mathf.MoveTowards(m_fadeAlpha, 1f, Time.deltaTime / m_fadeDuration);
	...
	// Refresh GUI
	public override void OnRangedAttackFired(APRangedAttack attack, APBullet bullet)
	{
